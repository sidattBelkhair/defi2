      ...
      <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
        ...
        <div class="nav-wrapper">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link " href="ajouter_mot.html">
                <i class="material-icons">note_add</i>
                <span>Ajouter un mot</span>
              </a>
            </li>
            <li class="nav-item"><a class="nav-link " href="traduction.html">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Les Mot disponibles</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <!-- Default Light Table -->
            ...
            <div class="col">
              <div class="card card-small mb-4">
                <div class="card-header border-bottom">
                  <!-- <h6 class="m-0">Toutes les mots</h6> -->
                  <form action="#" class="main-navbar__search w-50 d-none d-md-flex d-lg-flex">
                    <div class="input-group input-group-seamless ml-3">
                      <div class="input-group-prepend">
                        <div class="input-group-text">
                          <i class="fas fa-search"></i>
                      ...
                      <input class="navbar-search form-control" type="text" placeholder="Chercher pour un mot..."
                        aria-label="Search">
                    </div>
                  </form>
                </div>
                  ...
                  <table class="table mb-0">
                    <thead class="bg-light">
                      <tr>
                        ...
                        <th scope="col" class="border-0">Mot</th>
                        <th scope="col" class="border-0">Status</th>
                        <th scope="col" class="border-0">Utilisateur_id</th>
                        <th scope="col" class="border-0">Cree le</th>
                        <th scope="col" class="border-0">Mis-à-jours le</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>12-12-2024</td>
                        <td>12-12-2024</td>
                        <td><button class="mb-2 btn btn-outline-success mr-2">Valider</button>
                          <button class="mb-2 btn btn-outline-secondary mr-2">Modifier</button>
                          <button class="mb-2 btn btn-outline-warning mr-2">Supprimer</button>
                        </td>
                      </tr>
                      <tr>
                        <td>2</td>
