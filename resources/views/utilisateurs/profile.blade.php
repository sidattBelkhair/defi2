      ...
      <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
        ...
        <div class="nav-wrapper">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link " href="traduction.html">
              ...
              <div class="card card-small mb-4 pt-3">
                <div class="card-header border-bottom text-center">
                  <div class="mb-3 mx-auto">
                    <img class="rounded-circle" src="images/avatars/1.jpg" alt="User Avatar" width="110">
                  </div>
                  <h4 class="mb-0">Saleck Ameine</h4>
                  <span class="text-muted d-block mb-2">Moderateur</span>

                </div>
                <ul class="list-group list-group-flush">
                  <li class="list-group-item px-4">
                    <div class="progress-wrapper">
                      <strong class="text-muted d-block mb-2">Avancement Challenge</strong>
                        ...
                        <form>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" id="feFirstName" placeholder="Prenom"
                                value="Saleck">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="feLastName">Prenom </label>
                              <input type="text" class="form-control" id="feLastName" placeholder="prenom"
                                value="Ameine">
                            </div>
                          </div>
                          <div class="form-row">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="feDescription">Description de role</label>
                              <textarea class="form-control" name="feDescription"
                                rows="3">Lorem ipsum dolor sit amet consectetur adipisicing elit</textarea>
                            </div>
                          </div>
                          <button type="submit" class="btn btn-accent">Mis-à-jours</button>
                        </form>
                      </div>
                    </div>
                  </li>
